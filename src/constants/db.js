...
const db = {
  ...
  [T_FULLDAYTICKET]: {
    text: "Full day ticket",
    buttonTextToStep: "more than 2 hours",
    choices: [Q_NOTICKET],
  },
  [T_FOURSHORTTRIPTICKET]: {
    text: "Four Short Trip ticket",
    buttonTextToStep: "less than 20 min",
    choices: [Q_NOTICKET],
  },
  [T_FOURSINGLETICKET]: {
    text: "Four Single Trip ticket",
    buttonTextToStep: "less than 2 hours",
    choices: [Q_NOTICKET],
  },
  [T_ONEWEEKTICKETWITHBIKE]: {
    text: "One week ticket with bike",
    buttonTextToStep: "Yes",
    choices: [Q_NOTICKET],
  },
  [T_ONEWEEKTICKETWITHOUTBIKE]: {
    text: "One week ticket without bike",
    buttonTextToStep: "No",
    choices: [Q_NOTICKET],
  },
  [T_ONEMONTHTICKETTENAM]: {
    text: "One month ticket after 10am",
    buttonTextToStep: "No",
    choices: [Q_NOTICKET],
  },
  [T_ONEMONTHTICKET]: {
